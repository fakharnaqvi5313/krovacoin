...
RESOURCES += src/qt/krovacoin.qrc src/qt/krovacoin_locale.qrc

TRANSLATIONS += src/qt/locale/krovacoin_bg.ts \
                src/qt/locale/krovacoin_de.ts \
                src/qt/locale/krovacoin_en.ts \
                src/qt/locale/krovacoin_es.ts \
                src/qt/locale/krovacoin_fi.ts \
                src/qt/locale/krovacoin_fr.ts \
                src/qt/locale/krovacoin_it.ts \
                src/qt/locale/krovacoin_ja.ts \
                src/qt/locale/krovacoin_pl.ts \
                src/qt/locale/krovacoin_pt.ts \
                src/qt/locale/krovacoin_ru.ts \
                src/qt/locale/krovacoin_sk.ts \
                src/qt/locale/krovacoin_sv.ts \
                src/qt/locale/krovacoin_vi.ts \
                src/qt/locale/krovacoin_zh_CN.ts \
                src/qt/locale/krovacoin_zh_TW.ts

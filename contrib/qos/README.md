...
This means one can have an always-on krovad instance running, and another local krovad/krova-qt instance which connects to this node and receives blocks from it.

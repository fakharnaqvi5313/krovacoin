Contributing to KROVACOIN Core
============================

The KROVACOIN Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/krovacoin-project/krovacoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the KROVACOIN Core project, and is not to be
confused with overall KROVACOIN Network Protocol consensus changes.

Whether a pull request is merged into KROVACOIN Core rests with the project merge
...
Patches that change KROVACOIN consensus rules are considerably more involved than
...
Where a patchset proposes to change the KROVACOIN consensus, it must have been
...
The project leader is the release manager for each KROVACOIN Core release.

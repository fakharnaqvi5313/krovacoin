...
#error Client version information missing: version is not defined by krovacoin-config.h or in any other way
#endif
...
/**
 * krovad-res.rc includes this file, but it cannot cope with real c++ code.

...
// Copyright (c) 2017-2022 The KROVACOIN Core developers
...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("krovacoin"), "Krovacoin");
...
BOOST_AUTO_TEST_CASE(test_validateURL)
{
    ...
    BOOST_CHECK(validateURL("https://foo.bar/"));
    BOOST_CHECK(validateURL("http://krovacoin.foo.bar"));
    BOOST_CHECK(validateURL("https://foo.bar/krovacoin"));
    BOOST_CHECK(validateURL("https://foo.bar/krovacoin/more/"));
    BOOST_CHECK(validateURL("https://142.2.3.1"));
    BOOST_CHECK(validateURL("https://foo_bar.krovacoin.com"));

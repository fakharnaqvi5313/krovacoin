...
public:
    ...
    SERIALIZE_METHODS(CDiskBlockIndex, obj)
    {
        ...
        // KrovaCoin is a fresh chain with no on-disk block index predating
        // DBI_SER_VERSION_NO_ZC (which this node always writes), so the
        // older zerocoin-era and pre-stake-modifier-V2 formats this
        // upstream code originally read are unreachable and were removed.

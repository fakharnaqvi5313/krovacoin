...
#include "qt/krovacoin/addnewcontactdialog.h"
#include "qt/krovacoin/forms/ui_send.h"
#include "qt/krovacoin/guitransactionsutils.h"
#include "qt/krovacoin/loadingdialog.h"
#include "qt/krovacoin/optionbutton.h"
#include "qt/krovacoin/qtutils.h"
#include "qt/krovacoin/sendchangeaddressdialog.h"
...
SendWidget::SendWidget(KROVACOINGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
    coinIcon(new QPushButton())
{
    ...
    ui->btnUri->setSubTitleClassAndText("text-subtitle", tr("Parse a KROVACOIN URI"));
    ...
    setCssProperty(coinIcon, "coin-icon-krov");

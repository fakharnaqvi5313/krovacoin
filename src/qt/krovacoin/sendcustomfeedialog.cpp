...
#include "qt/krovacoin/sendcustomfeedialog.h"
#include "qt/krovacoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(KROVACOINGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &KROVACOINGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);

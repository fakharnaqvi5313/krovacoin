...
#include "qt/krovacoin/forms/ui_topbar.h"
#include "qt/krovacoin/lockunlock.h"
#include "qt/krovacoin/qtutils.h"
#include "qt/krovacoin/receivedialog.h"
#include "qt/krovacoin/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/krovacoin/balancebubble.h"
...
TopBar::TopBar(KROVACOINGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("KROVACOIN")
    updateDisplayUnit();

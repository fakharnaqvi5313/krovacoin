...
#include "qt/krovacoin/createproposaldialog.h"
#include "qt/krovacoin/forms/ui_createproposaldialog.h"

#include "qt/krovacoin/contactsdropdown.h"
...
CreateProposalDialog::CreateProposalDialog(KROVACOINGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageOne()
{
    ...
    setEditBoxStyle(ui->labelURL, ui->lineEditURL, "e.g https://forum.krovacoin/proposals/best_proposal_ever");
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "e.g 500 KROV");
...
void CreateProposalDialog::onAddrListClicked()
{
    ...
    if (!menuContacts) {
        ...
        menuContacts = new ContactsDropdown(
                width,
                height,
                dynamic_cast<KROVACOINGUI*>(parent()),
                this
        );

...
#include <QWidget>
#include "qt/krovacoin/pwidget.h"
#include "qt/krovacoin/settings/settingsbackupwallet.h"
#include "qt/krovacoin/settings/settingsexportcsv.h"
#include "qt/krovacoin/settings/settingsbittoolwidget.h"
#include "qt/krovacoin/settings/settingssignmessagewidgets.h"
#include "qt/krovacoin/settings/settingswalletrepairwidget.h"
#include "qt/krovacoin/settings/settingswalletoptionswidget.h"
#include "qt/krovacoin/settings/settingsmainoptionswidget.h"
#include "qt/krovacoin/settings/settingsdisplayoptionswidget.h"
#include "qt/krovacoin/settings/settingsinformationwidget.h"
#include "qt/krovacoin/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(KROVACOINGUI* parent);
    ~SettingsWidget();

...
#include "qt/krovacoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/krovacoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(KROVACOINGUI* _window, QWidget *parent) :

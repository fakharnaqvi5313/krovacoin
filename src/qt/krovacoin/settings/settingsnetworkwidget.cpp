// Copyright (c) 2019 The KROVACOIN Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#include "qt/krovacoin/settings/settingsnetworkwidget.h"
#include "qt/krovacoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/krovacoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(KROVACOINGUI* _window, QWidget *parent) :

...
#include "qt/krovacoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/krovacoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(KROVACOINGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to KROVACOINGUI::handleRestart()

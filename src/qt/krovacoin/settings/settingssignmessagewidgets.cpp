...
#include "qt/krovacoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(KROVACOINGUI* _window, QWidget *parent) :

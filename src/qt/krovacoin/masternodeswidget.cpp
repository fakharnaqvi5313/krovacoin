...
#include "qt/krovacoin/forms/ui_masternodeswidget.h"

#include "qt/krovacoin/qtutils.h"
#include "qt/krovacoin/mnrow.h"
#include "qt/krovacoin/mninfodialog.h"
#include "qt/krovacoin/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(KROVACOINGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= mnCollateralAmount) {
        inform(tr("Not enough balance to create a masternode, %1 required.")
            .arg(GUIUtil::formatBalance(mnCollateralAmount, BitcoinUnits::KROV)));
        return;
    }

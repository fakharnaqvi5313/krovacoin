...
#ifndef KROVACOIN_CORE_NEW_GUI_KROVACOINGUI_H
#define KROVACOIN_CORE_NEW_GUI_KROVACOINGUI_H
...
#include "qt/krovacoin/navmenuwidget.h"
#include "qt/krovacoin/topbar.h"
#include "qt/krovacoin/dashboardwidget.h"
#include "qt/krovacoin/send.h"
...
/**
  KROVACOIN GUI main class. This class represents the main window of the KROVACOIN UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class KROVACOINGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit KROVACOINGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~KROVACOINGUI();
...
#endif //KROVACOIN_CORE_NEW_GUI_KROVACOINGUI_H

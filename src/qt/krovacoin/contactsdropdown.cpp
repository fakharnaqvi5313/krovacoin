...
#include <QPainter>
#include <QSizePolicy>
#include "qt/krovacoin/addresslabelrow.h"
#include "qt/krovacoin/contactdropdownrow.h"
...
ContactsDropdown::ContactsDropdown(int minWidth, int minHeight, KROVACOINGUI* _window, QWidget* _parent) : PWidget(_window, _parent)
{

...
/** Utility functions used by the KROVACOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render KROVACOIN addresses in monospace font
...
// Parse "krovacoin:" URI into recipient object, return true on successful parsing

...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            KROVACOINGUI* window = static_cast<KROVACOINGUI*>(parentWidget());
...
{
    KROVACOINGUI* gui = static_cast<KROVACOINGUI*>(parentWidget());
...
{
    hide();
    static_cast<KROVACOINGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +

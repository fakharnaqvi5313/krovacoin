 ...
 *  A CTxDestination is the internal data type encoded in a KROVACOIN address
 */
...
/**
 * Generate a KROVACOIN scriptPubKey for the given CTxDestination. Returns a P2PKH

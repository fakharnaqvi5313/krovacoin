...
extern const char * const KROVACOIN_CONF_FILENAME;
extern const char * const KROVACOIN_PID_FILENAME;
extern const char * const KROVACOIN_MASTERNODE_CONF_FILENAME;

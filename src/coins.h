...
public:
    ...
    /**
     * Amount of krovacoin coming in to a transaction
...
// KROVACOIN: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect

...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = PACKAGE_NAME " krova-tx utility version " + FormatFullVersion() + "\n\n" +
                               "Usage:  krova-tx [options] <hex-tx> [commands]  Update hex-encoded krovacoin transaction\n" +
                               "or:     krova-tx [options] -create [commands]   Create hex-encoded krovacoin transaction\n" +
                               "\n";
...
static CAmount AmountFromValue(const UniValue& value)
{
    ...
    if (dAmount <= 0.0 || dAmount > 72000000000.0)
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded krovacoin transaction

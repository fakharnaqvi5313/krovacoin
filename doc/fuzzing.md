...
To build KROVACOIN Core using AFL instrumentation (this assumes that the
...
with certain assembly code from KROVACOIN Core's code. See [developer notes on sanitizers](https://github.com/KROVACOIN-Project/KROVACOIN/blob/master/doc/developer-notes.md#sanitizers)

...
# Copyright (c) 2020-2022 The KROVACOIN Core developers
...
class FullBlockTest(KrovacoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure krovad isn't accepting b26
        ...
        # Extend the b28 chain to make sure krovad isn't accepting b28
        ...
        # KROVACOIN: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the krovacoin code has custom code which does so);

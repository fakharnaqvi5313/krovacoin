...
By default, krovad will dump mempool on shutdown and
...
class MempoolPersistTest(KrovacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent krovad from writing mempool.dat to disk. Verify that `savemempool` fails")

...
from test_framework.test_framework import KrovacoinTestFramework, SkipTest
...
class ZMQTest (KrovacoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that krovacoin has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("krovad has not been built with zmq enabled.")

...
class ReorgStakeTest(KrovacoinTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        # verify that nodes have the expected KROV supply
    ...
    def run_test(self):
        ...
        # Verify that KROV supply was properly updated after the reorgs (including burned fee)
        self.log.info("Check KROV supply...")

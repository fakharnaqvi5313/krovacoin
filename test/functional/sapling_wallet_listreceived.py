...
class ListReceivedTest (KrovacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 KROV.
        ...
        # Send 1 KROV to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 KROV sending them all (fee is 0.1 KROV)
        ...
        # Confirm transaction (2 KROV from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 KROV, send 0.6 KROV + 0.05 KROV fee

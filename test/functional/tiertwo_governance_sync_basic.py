...
from test_framework.test_framework import KrovacoinTier2TestFramework
...
class MasternodeGovernanceBasicTest(KrovacoinTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposal = Proposal(
            "super-cool",
            "https://forum.krovacoin.org/t/test-proposal",
            2,

...
class DIP3Test(KrovacoinTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 KROV) to the operator, and (2 * 2.7 KROV) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid KROVACOIN address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid KROVACOIN address InvalidPayee", controller.protx_update_registrar,

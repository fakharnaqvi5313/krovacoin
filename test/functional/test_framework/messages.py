...
COIN = 100000000  # 1 KROV in satoshis
...
# Objects that map to krovad objects, which can be serialized/deserialized
class CAddress:
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in krovad indicates these should be deserialized as blocks
